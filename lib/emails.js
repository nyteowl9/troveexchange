...
export async function emailSellerFundsReleased({ to, order }) {
  return resend.emails.send({
    ...
    html: layout(`
      ...
      <table width="100%" style="border:1px solid #2A2A32;border-radius:10px;padding:16px;" cellpadding="8">
        <tr><td style="color:#6C6A66;font-size:13px;">Payout</td><td style="color:#4CAF7C;font-size:14px;font-weight:700;text-align:right;">$${parseFloat(order.seller_payout || 0).toFixed(2)} USDC</td></tr>
